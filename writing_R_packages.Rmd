...
of upper and lower cases (RColorBrewer or Rcolorbrewer? EcoSimR or ecosimR or ecosimr?)
...
It is convenient to use package `roxygen2` (see also [this site](https://cran.r-project.org/web/packages/roxygen2/vignettes/roxygen2.html)) to add the documentation directly 
to the .R files.
...
Once we have everyting ready, we can build and install the package. In R studio
there is just **one button** for that.
...
4. Update man files, e.g. with the help of `roxygen2::roxygenize`.
